        ...
        {carrito.length > 0 ?
           ...
           const {cantidad,title,price} = item
				      return(
                         ...
                         <i> $ {price * cantidad}</i> 
                            <button onClick={()=> handleDelete(item.id)} className='eliminar'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
